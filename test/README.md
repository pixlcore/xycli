...
| `sync-unit` | Offline up-only deletion guards, inherited settings and CLI overrides, error exit status, quiet/dry runs, completion failures, and notification delivery after errors |
