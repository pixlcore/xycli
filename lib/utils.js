...
const STANDARD_API_PROPERTY_RULES = {
	'^(create_alert|update_alert)$': [
		...
		'abort_jobs', 'notes', 'username', 'modified', 'created', 'revision', 'sync'
	],
	...
	'^(create_category|update_category)$': [
		...
		'sort_order', 'username', 'modified', 'created', 'revision', 'sync'
	],
	...
	'^(create_plugin|update_plugin)$': [
		...
		'notes', 'marketplace', 'username', 'modified', 'created', 'revision', 'sync'
	],
	...
	'^(create_tag|update_tag)$': [
		'id', 'title', 'icon', 'notes', 'username', 'modified', 'created', 'revision', 'sync'
	],
	...
	'^(create_web_hook|update_web_hook)$': [
		...
		'username', 'modified', 'created', 'revision', 'sync'
	]
};
